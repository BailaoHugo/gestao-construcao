                    ...
                    return (
                      <tr key={t.id} className={`border-b border-slate-200 ${ti % 2 === 0 ? 'bg-white' : 'bg-slate-50/30'}`}>
                        ...
                        {dias.map(d => {
                          ...
                          if (!wd) {
                            if (h === 0) {
                              cls += 'bg-slate-100/60 text-slate-300 hover:bg-slate-200/60 cursor-pointer';
                            } else if (h >= 8) {
                              cls += 'bg-orange-50 text-orange-700 hover:bg-orange-100 cursor-pointer';
                            } else {
                              cls += 'bg-orange-50/70 text-orange-600 hover:bg-orange-100/70 cursor-pointer';
                            }
                          } else if (h === 0) {
                          ...
                          return (
                            <td key={data} className={cls} onClick={() => openModal(t, d)}>
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-6 w-full max-w-sm mx-4" onClick={e => e.stopPropagation()}>
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <select value={formObra} onChange={e => setFormObra(e.target.value)} className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
