-- 20260415_despesa_linhas.sql
-- Adiciona suporte a linhas de fatura e campos IVA às despesas

-- Novas colunas na tabela despesas
...
-- Tabela de linhas de despesa (detalhe por artigo)
